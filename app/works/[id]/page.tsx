...
export default async function WorkDetailPage({
  ...
  const movieReleaseLabel = work.media === "movie" ? formatReleaseDate(work) : null;
      ...
      <header className="card mt-3 p-5 sm:p-7 grid grid-cols-1 sm:grid-cols-[190px_1fr] gap-6 sm:gap-8">
        ...
        <div className="flex flex-col min-w-0">
          <div className="flex items-center gap-2.5 flex-wrap">
            ...
            {work.media === "movie" && movieReleaseLabel && (
              <span className="text-sm font-bold text-primary">公開: {movieReleaseLabel}〜</span>
            )}
          </div>
